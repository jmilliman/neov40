...
<body class="body-blue">
  ...
  <div class="context-menu">
    ...
    <br>
    <p class="ptext-cmenu"><a class="ptext-bright" href="plcyterms.php">Terms &amp; Conditions</a></p>
    <br>
    <p class="ptext-cmenu"><a class="ptext-dim" href="plcyrefunds.php">Refund Policy</a></p>
  </div>
  ...
  <main class="page-wrap">
    ...
    <article class="article--small"> <!-- Terms & Conditions -->
      ...
      <p class="ptext-small">
        <br> <span class="ptext-small-bold">OVERVIEW</span>
        <br>
        <br> This website is operated by Napasha Way LLC. Throughout the site, the terms <span class="ptext-small-italic">we, us</span> and <span class="ptext-small-italic">our</span> refer to Napasha Way LLC. Napasha Way LLC offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
        <br>
        <br> By visiting our site and/or purchasing something from us, you engage in our <span class="ptext-small-italic">Service</span> and agree to be bound by the following terms and conditions (<span class="ptext-small-italic">Terms of Service</span>, <span class="ptext-small-italic">Terms</span>), including those additional terms and conditions and policies referenced herein and/or available by hyperlink. These Terms of Service apply to all users of the site, including without limitation users who are browsers, vendors, customers, merchants, and/or contributors of content.
        <br>
        ...
        <br>
        <br> Any new features or tools that are added to the current store shall also be subject to the Terms of Service. You can review the most current version of the Terms of Service at any time on this page. We reserve the right to update, change or replace any part of these Terms of Service by posting updates and/or changes to our website. It is your responsibility to check this page periodically for changes. Your continued use of or access to the website following the posting of any changes constitutes acceptance of those changes.
        <br>
        <br>

        <span class="ptext-small-bold">SECTION 1 - ONLINE STORE TERMS</span>
        <br>
        ...
        <br>
        <br> You may not use our products for any illegal or unauthorized purpose. You may not, in the use of the Service, violate any laws in your jurisdiction including but not limited to copyright laws.
        <br>
        ...
        <span class="ptext-small-bold">SECTION 2 - GENERAL CONDITIONS</span>
        <br>
        ...
        <br>
        <br> You agree not to reproduce, duplicate, copy, sell, resell or exploit any portion of the Service (including content on this site), use of the Service, or access to the Service or any contact on the website through which the service is provided, without express written permission by us.
        <br>
        <br> Unless otherwise stated, Napasha Way LLC and/or its licensors own the intellectual property rights in the website and material on the website. Subject to the license below, all these intellectual property rights are reserved.
        <br>
        <br> You may view, download for caching purposes only, and print from the website for your own personal use, subject to the restrictions set out below and elsewhere in these terms and conditions.
        <br>
        <br> You must not:
      </p>

      <ul class="ul-disc ptext-small">
        <li>Republish material from this website (including republication on another website).</li>
        <li>Sell, rent or sub-license material from the website; (c) show any material from the website in public.</li>
        <li>Reproduce, duplicate, copy or otherwise exploit material on this website for a commercial purpose.</li>
        <li>Edit or otherwise modify any material on the website or redistribute material from this website.</li>
      </ul>
      ...
      <p class="ptext-small">
        ...
        <span class="ptext-small-bold">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 5 - PRODUCTS OR SERVICES</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 8 - THIRD-PARTY LINKS</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 10 - PERSONAL INFORMATION</span>
        <br>
        <br> Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy.
        <br>
        <br>


        <span class="ptext-small-bold">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 12 - PROHIBITED USES</span>
        <br>
      ...
      <p class="ptext-small">
        ...
        <span class="ptext-small-bold">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</span>
        <br>
        ...
        <br>
        <br> In no case shall Napasha Way LLC, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
        <br>
        <br>


        <span class="ptext-small-bold">SECTION 14 - INDEMNIFICATION</span>
        <br>
        <br> You agree to indemnify, defend and hold harmless Napasha Way LLC and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
        <br>
        <br>


        <span class="ptext-small-bold">SECTION 15 - SEVERABILITY</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 16 - TERMINATION</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 17 - ENTIRE AGREEMENT</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 18 - GOVERNING LAW</span>
        <br>
        <br> These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of 59 Napasha Lane, Buffalo MO 65622.
        <br>
        <br>


        <span class="ptext-small-bold">SECTION 19 - CHANGES TO TERMS OF SERVICE</span>
        <br>
        ...
        <span class="ptext-small-bold">SECTION 20 - CONTACT INFORMATION</span>
        <br>
        <br> Questions about the Terms of Service should be sent to us at admin@NapashaWay.com.
        <br>
        <br>
        <br>
      </p>
